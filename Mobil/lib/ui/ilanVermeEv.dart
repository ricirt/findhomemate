...
class Ilanverme extends StatefulWidget {
  @override
  _IlanvermeState createState() => _IlanvermeState();
}

class _IlanvermeState extends State<Ilanverme> {
    File _secilenResim;
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                RaisedButton(child: Text("Galeriden Resim Yukle"),color:Colors.blueAccent,onPressed: _galeriResim,),
                RaisedButton(child: Text("Kameradan Resim Yukle"),color:Colors.blueAccent,onPressed: _kameraResim,),
                TextFormField(
